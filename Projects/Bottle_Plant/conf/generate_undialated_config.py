...
Max_nodes = 63
node = 0
reader_path = "/home/vignesh/Desktop/awlsim-0.42/s3fnet-lxc/lxc-command/reader_modified"
...
while node <= Max_nodes :
	...
	with open("/tmp/" + lxc_name,"w") as f :
		if node == Max_nodes :
			f.write("python /home/vignesh/Desktop/awlsim-0.42/Projects/Bottle_Plant/conf/PLC_Config/udp_reader.py\n")
		else:
			f.write("/home/vignesh/Desktop/awlsim-0.42/tests/run.sh -e 0 --node " + str(node) + " /home/vignesh/Desktop/awlsim-0.42/tests/modbus/bottle_plant_node/bottle_plant_node.awl\n")
